...
import { closeSnackBarSpocify } from "./redux/snackbarslice.slice";
...
const SnackbarSpocify: React.FC = () => {
	...
	return (<Stack sx={{ width: "100%", zIndex:10 }}>
		<Snackbar
			...
			onClose={()=> dispatch(closeSnackBarSpocify())}
			TransitionComponent={TransitionLeft}
			autoHideDuration={snackbarState.autoHideDuration}
			key={"snackbar-major-village"}>
			<Alert onClose={()=> dispatch(closeSnackBarSpocify())} severity={snackbarState.severity} sx={{ width: "100%" }}>
				<AlertTitle>
					{snackbarState.title}
				</AlertTitle>
...
export default SnackbarSpocify;
